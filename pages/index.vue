  ...
  <div class="px-5 ">
    ...
    <div class="flex flex-col xl:flex-row gap-4 pt-4">
      ...
      <div class="flex flex-col gap-5 flex-grow">
        <AliveServerRow name="MC Eternal 2" version="1.1.1.0" image-path="/img/mce2-2.png" hostname="mce2.ihatemy.live" mapUrl='https://atm10.ihatemy.live'/>
        <AliveServerRow name="Society: Sunlit Valley" version="3.3.5" image-path="/img/sv.png" hostname="sv.ihatemy.live" mapUrl='https://atm10.ihatemy.live'/>
        <AliveServerRow name="Prominence 2" version="3.9.3" image-path="/img/p2he.png" hostname="p2he.ihatemy.live" mapUrl='https://atm10.ihatemy.live'/>
        <AliveServerRow name="All The Mods 10" version="4.14" image-path="/img/atm10.png" hostname="atm10.ihatemy.live" mapUrl='https://atm10.ihatemy.live'/>
        <AliveServerRow name="All The Mods 9" version="1.1.0" image-path="/img/atm9.png" hostname="atm9.ihatemy.live" mapUrl='https://atm9.ihatemy.live'/>
        ...
        <DedServerRow name="The 1.12.2 Pack" reason-of-death="sharted itself" image-path="/img/1122.png" download-path="https://map-storage.ihatemy.live/maps/1122.zip" />
      </div>
    </div>
  </div>
</template>
