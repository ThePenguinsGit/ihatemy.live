  ...
  <div class="px-5 ">
    ...
    <div class="flex flex-col xl:flex-row gap-4 pt-4">
      ...
      <div class="flex flex-col gap-5 flex-grow">
        ...
        <AliveServerRow name="Prominence 2" version="3.9.0" image-path="/img/p2he.png" hostname="p2he.ihatemy.live" mapUrl='https://atm10.ihatemy.live'/>
        <AliveServerRow name="All The Mods 10" version="4.11" image-path="/img/atm10.png" hostname="atm10.ihatemy.live" mapUrl='https://atm10.ihatemy.live'/>
