  ...
  <div class="px-5 ">
    ...
    <div class="flex flex-col xl:flex-row gap-4 pt-4">
      ...
      <div class="flex flex-col gap-5 flex-grow">
        <AliveServerRow name="All The Mods 10" version="2.34" image-path="/img/atm10.png" hostname="atm10.ihatemy.live" mapUrl='https://atm10.ihatemy.live'/>
        <AliveServerRow name="All The Mods 9" version="1.0.3" image-path="/img/atm9.png" hostname="atm9.ihatemy.live" mapUrl='https://atm9.ihatemy.live'/>
