  ...
  <div class="px-5 ">
    ...
    <div class="flex flex-col xl:flex-row gap-4 pt-4">
      ...
      <div class="flex flex-col gap-5 flex-grow">
        <AliveServerRow name="MC Eternal 2" version="1.1.0.2" image-path="/img/mce2-2.png" hostname="mce2.ihatemy.live" mapUrl='https://atm10.ihatemy.live'/>
        ...
        <AliveServerRow name="All The Mods 10" version="4.2" image-path="/img/atm10.png" hostname="atm10.ihatemy.live" mapUrl='https://atm10.ihatemy.live'/>
